...
Gem::Specification.new do |s|
  ...
  s.test_files = ["./tests/test_json_string_matching.rb", "./tests/test_json.rb", "./tests/test_json_fixtures.rb", "./tests/test_json_unicode.rb", "./tests/test_json_generate.rb", "./tests/test_json_generic_object.rb", "./tests/test_json_encoding.rb", "./tests/test_json_addition.rb"]
